...
tic = document.getElementById('tictictic'),
islandss = document.getElementById('islands'),
lvl2lnk = document.getElementById('lvl2lnk'),
head = document.getElementsByTagName('HEAD')[0],
newlvl2 = document.getElementById('ii2');
bwin= false
...
if (bwin == false){
    rbtnw.onclick = ()=>{
        newlvl2.src = 'images/p2.png'
        tic.style.display= 'none'
        islandss.style.display = 'flex'
        linkk.rel = 'stylesheet'
        linkk.type = 'text/css'
        linkk.href = 'styles/p2hover.css'
        head.appendChild(linkk)
        lvl2lnk.onclick = startlevel2()
    }
}